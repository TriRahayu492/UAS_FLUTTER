  ...
  Widget build(BuildContext context) {
    var calc = SimpleCalculator(
      ...
      theme: const CalculatorThemeData(
        ...
        expressionColor: Color.fromARGB(255, 6, 55, 255),
        expressionStyle: TextStyle(fontSize: 20, color: Colors.blue),
        operatorColor: Color.fromARGB(255, 255, 255, 255),
        operatorStyle: TextStyle(fontSize: 30, color: Colors.blue),
        commandColor: Colors.white,
        commandStyle: TextStyle(fontSize: 30, color: Colors.blue),
        numColor: Color.fromARGB(255, 248, 252, 255),
